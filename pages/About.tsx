    ...
    <main className="bg-white relative selection:bg-brand-accent selection:text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <motion.div {...revealProps} className="space-y-10">
              <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900">The Awareness <br/>Methodology.</h2>
              <p className="text-sm sm:text-base text-slate-600 font-light leading-relaxed">
                Awareness Africa Foundation operates as an umbrella organization, providing resources and data-driven strategies to targeted interventions.
              </p>
              <div className="space-y-6">
                {[
                  { icon: <Target size={20} className="text-[#C5A059]" />, title: "Precision Intervention", desc: "Data-led mapping of community needs to ensure efficient resource allocation." },
                  { icon: <Shield size={20} className="text-[#E91E63]" />, title: "Protection Frameworks", desc: "Building safety nets through education and reproductive health literacy." },
                  { icon: <Zap size={20} className="text-[#1976D2]" />, title: "Rapid Resilience", desc: "Equipping young men with mental tools to combat emotional isolation." }
                ].map((pillar, i) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-px bg-slate-100 border border-slate-100">
           <motion.div {...revealProps} className="p-10 md:p-16 bg-white space-y-6">
              ...
              <p className="text-xl sm:text-3xl font-display font-bold text-slate-900 leading-tight">
                An Africa where every young person is emotionally resilient and economically empowered.
              </p>
           </motion.div>
           <motion.div {...revealProps} transition={{ delay: 0.2 }} className="p-10 md:p-16 bg-white space-y-6">
              ...
              <p className="text-xl sm:text-3xl font-display font-bold text-slate-900 leading-tight">
                To catalyze social change through institutional partnerships and grassroots intervention.
              </p>
           </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 sm:py-32 px-6 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div {...revealProps}>
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-8">Institutional <br/>Integrity.</h2>
            <p className="text-white/40 text-sm font-light mb-12 max-w-xl mx-auto">
              Our governance model ensures total transparency and accountability to our donors and communities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="w-full sm:w-auto px-10 border-white/20 text-white hover:bg-white/10" onClick={() => navigate('/resources')}>Annual Reports</Button>
            </div>
          </motion.div>
        </div>
      </section>
