...
const VALUES = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1529391409740-59f2dea08bc6?q=80&w=800&auto=format&fit=crop",
...
const CoreValues: React.FC = () => {
  return (
    <section className="relative overflow-hidden border-b-[16px] border-brand-primary">
      ...
      <div className="bg-[#2D0A4E] pt-24 pb-48 px-6 text-center">
        <motion.div
      ...
      <div className="bg-[#FFFDF5] pb-32 px-6">
            ...
            {VALUES.map((value, index) => (
              ...
              >
                ...
                <div className="p-10 flex-grow">
                  <h3 className="text-2xl font-display font-bold text-slate-900 mb-6 group-hover:text-white transition-colors duration-500">
                    {value.title}
                  </h3>
